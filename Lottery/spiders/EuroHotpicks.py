...
class EurohotpicksSpider(scrapy.Spider):
    name = 'EuroHotpicks'
    allowed_domains = ['www.results.co.uk']
    start_urls = ['http://www.results.co.uk/euromillions-hotpicks-results']
    custom_settings = {
        # 'USER_AGENT': 'Mozilla/5.0 (Macintosh; Intel Mac OS X 10_12_6) AppleWebKit/537.36 (KHTML, like Gecko) Chrome/61.0.3163.100 Safari/537.36',
        'ITEM_PIPELINES': { 'Lottery.pipelines.EuroHotpicks': 300 }
    }
